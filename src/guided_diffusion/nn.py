...
try:
    _checkpoint_amp_custom_fwd = th.amp.custom_fwd(device_type="cuda")
    _checkpoint_amp_custom_bwd = th.amp.custom_bwd(device_type="cuda")
except AttributeError:
    # PyTorch < 2.0 / builds without torch.amp.custom_fwd
    _checkpoint_amp_custom_fwd = th.cuda.amp.custom_fwd
    _checkpoint_amp_custom_bwd = th.cuda.amp.custom_bwd


class CheckpointFunction(th.autograd.Function):
    @staticmethod
    @_checkpoint_amp_custom_fwd
