...
def main(cli_overrides: dict | None = None) -> None:
    ...
    GENERATION_MODE = run_config.generation_mode  # Literal: "None" | "2D" | "3D" | "3D_latent"
    ...
    def do_run():
      ...
      for frame_num in range(args.start_frame, args.max_frames):
                            ...
                            if turbo_mode:
                                if frame_num == effective_turbo_preroll:  # start tracking oldframe
                                    ...
                                    if args.animation_mode == "3D_latent":
                                        ...
                                        old_frame = do_3d_step(old_frame_scaled_path, frame_num, depth_backend_instance)
          ...
          elif args.animation_mode == "3D_latent" and latent_first_frame_strategy == "black":
    ...
    def _apply_cli_overrides(ov: dict | None) -> None:
        ...
        nonlocal transformation_percent, text_prompts, image_prompts
    ...
    """
    ### Prompts
    When GENERATION_MODE is "None", only the first prompt set is used. For "2D" and 3D modes, prompts advance per frame and hold on the last defined frame.
    """
